...
download.packages(c('arrow', 'shape', 'RcppEigen', 'glmnet', 'kernlab'), 
                  repos = 'https://packagemanager.rstudio.com/cran/__linux__/focal/2022-11-08', 
                  destdir = dest_dir)

download.packages(c('clock', 'Cubist', 'fracdiff', 'lmtest', 'quadprog', 'tseries', 'urca', 'RcppArmadillo', 
                    'forecast', 'SparseM', 'hts', 'V8', 'parsnip', 'plotrix',
                    'dygraphs', 'extraDistr', 'RcppParallel', 'rstan', 'rstantools', 'BH',
                    ...
                    'yardstick', 'reactable', 'checkmate', 'gt', 'janitor', 'xgboost', 'gtools', 'fs', 
                    'generics', 'doParallel', 'foreach', 'digest', 'GPfit', 'lhs', 'tune', 
                    'StanHeaders', 'timetk', 'prophet',
